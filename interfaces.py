...
class steamclient64_dll: # steamclient64.dll
    IVALIDATE001 = 0x8656F0
    CLIENTENGINE_INTERFACE_VERSION005 = 0x8613E0
    SteamClient021 = 0x660000
    SteamClient020 = 0x65FFF0
    SteamClient019 = 0x65FFE0
    SteamClient018 = 0x65FFD0
    SteamClient017 = 0x65FFC0
    SteamClient016 = 0x65FFB0
    SteamClient015 = 0x65FFA0
    SteamClient014 = 0x65FF90
    SteamClient013 = 0x65FF80
    SteamClient012 = 0x65FF70
    SteamClient011 = 0x65FF60
    SteamClient010 = 0x65FF50
    SteamClient009 = 0x65FF40
    SteamClient008 = 0x65FF30
    SteamClient007 = 0x65FF20
    SteamClient006 = 0x65FF10
    p2pvoice002 = 0xDAA60
    p2pvoicesingleton002 = 0xD74D0
...
class vstdlib_s64_dll: # vstdlib_s64.dll
    IVALIDATE001 = 0x24DE0
    VEngineCvar002 = 0x57A0
