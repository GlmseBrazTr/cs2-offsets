...
pub mod steamclient64_dll { // steamclient64.dll
    pub const IVALIDATE001: usize = 0x8656F0;
    pub const CLIENTENGINE_INTERFACE_VERSION005: usize = 0x8613E0;
    pub const SteamClient021: usize = 0x660000;
    pub const SteamClient020: usize = 0x65FFF0;
    pub const SteamClient019: usize = 0x65FFE0;
    pub const SteamClient018: usize = 0x65FFD0;
    pub const SteamClient017: usize = 0x65FFC0;
    pub const SteamClient016: usize = 0x65FFB0;
    pub const SteamClient015: usize = 0x65FFA0;
    pub const SteamClient014: usize = 0x65FF90;
    pub const SteamClient013: usize = 0x65FF80;
    pub const SteamClient012: usize = 0x65FF70;
    pub const SteamClient011: usize = 0x65FF60;
    pub const SteamClient010: usize = 0x65FF50;
    pub const SteamClient009: usize = 0x65FF40;
    pub const SteamClient008: usize = 0x65FF30;
    pub const SteamClient007: usize = 0x65FF20;
    pub const SteamClient006: usize = 0x65FF10;
    pub const p2pvoice002: usize = 0xDAA60;
    pub const p2pvoicesingleton002: usize = 0xD74D0;
}
