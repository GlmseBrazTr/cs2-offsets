...
namespace steamclient64_dll { // steamclient64.dll
    constexpr std::ptrdiff_t IVALIDATE001 = 0x8656F0;
    constexpr std::ptrdiff_t CLIENTENGINE_INTERFACE_VERSION005 = 0x8613E0;
    constexpr std::ptrdiff_t SteamClient021 = 0x660000;
    constexpr std::ptrdiff_t SteamClient020 = 0x65FFF0;
    constexpr std::ptrdiff_t SteamClient019 = 0x65FFE0;
    constexpr std::ptrdiff_t SteamClient018 = 0x65FFD0;
    constexpr std::ptrdiff_t SteamClient017 = 0x65FFC0;
    constexpr std::ptrdiff_t SteamClient016 = 0x65FFB0;
    constexpr std::ptrdiff_t SteamClient015 = 0x65FFA0;
    constexpr std::ptrdiff_t SteamClient014 = 0x65FF90;
    constexpr std::ptrdiff_t SteamClient013 = 0x65FF80;
    constexpr std::ptrdiff_t SteamClient012 = 0x65FF70;
    constexpr std::ptrdiff_t SteamClient011 = 0x65FF60;
    constexpr std::ptrdiff_t SteamClient010 = 0x65FF50;
    constexpr std::ptrdiff_t SteamClient009 = 0x65FF40;
    constexpr std::ptrdiff_t SteamClient008 = 0x65FF30;
    constexpr std::ptrdiff_t SteamClient007 = 0x65FF20;
    constexpr std::ptrdiff_t SteamClient006 = 0x65FF10;
    constexpr std::ptrdiff_t p2pvoice002 = 0xDAA60;
    constexpr std::ptrdiff_t p2pvoicesingleton002 = 0xD74D0;
}
